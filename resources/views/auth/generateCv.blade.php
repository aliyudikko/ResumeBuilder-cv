    ...
    <form  action="{{ route('cv.store') }}" method="post" 
      enctype="multipart/form-data"   class="form">
       ...
       <!-- logo -->
        ...
        <h3 class="text-3xl p-3 text-fuchsia-600">New Job Application Form</h3>
...
<div id="template2" class="data">   
    ...
    <div class="flex  w-36 md:w-auto  
    items-center pb-11 py-24 md:pb- md:my-14 ml-11 md:ml-14 justify-center  container">
       
    <div class="md:grid flex flex-row w-11 
       md:w-auto  md:grid-cols-2  mx-auto">
       
           <div class=" bg-white w-52 md:w-[300px] px-3 md:px-11 
             rounded-xl   h-95 text-white 
            ">
...
<div id="template3" class="data">
    <a href="{{ route('cv.template1', 3)}}" class="text-3xl text-center
     text">
     <div class="form-navigation flex gap-x-11  justify-center pb-11">
      <div>     
      <button class="shadow-lg w-fullinline-block px-6 py-2 rounded text-base font-medium cursor-pointer
    ...
    <div class="flex  
     items-center my-14 w-11  justify-center  mx-auto container">
        ...
        <div class=" bg-fuchsia-700 w-36 md:w-72
          rounded-xl px-1 pr-4  md:px-11 h-95 text-white  p-4">
        ...
        <div class="bg-white border-b-2 
         border-fuchsia-600 py-28 md:py-20 pl-5 rounded-lg shadow-md flex-1 ">
